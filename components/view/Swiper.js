    ...
    onScroll(e) {
        if (this.scrollView) {
            ...
            if (currentPageInt === 0 || currentPageInt >= 0.9) {
                // console.log('currentPageFloat='+currentPageFloat);
            ...
            // console.log('this.ezswiper.currentIndex='+this.ezswiper.currentIndex);
            if (oldIndex !== this.ezswiper.currentIndex || (oldIndex == 0 && this.ezswiper.currentIndex == 0)) {
